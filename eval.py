...
def main(args):
    ...
    # languages = ['en', 'de']
    data_names = ['pphuc25/EngMed',  'Hanhpt23/GermanMed-full']
    data_names = ['pphuc25/VietMed-split-8-2', 'pphuc25/EngMed', 'pphuc25/FranceMed', 'pphuc25/ChiMed', 'Hanhpt23/GermanMed-full']
    model_names = {
        'vi': ['Hanhpt23/whisper-medium-vietmed-v1', 'Hanhpt23/whisper-small-vietmed-v1', 'Hanhpt23/whisper-base-vietmed-v1', 'Hanhpt23/whisper-tiny-vietmed-v1'],
        'en': ['Hanhpt23/whisper-medium-engmed-v2', 'Hanhpt23/whisper-small-engmed-v2', 'Hanhpt23/whisper-base-engmed-v2', 'Hanhpt23/whisper-tiny-engmed-v2'],
        'fr': ['Hanhpt23/whisper-medium-frenchmed-v1', 'Hanhpt23/whisper-small-frenchmed-v1', 'Hanhpt23/whisper-base-frenchmed-v1', 'Hanhpt23/whisper-tiny-frenchmed-v1'],
        'zh': ['Hanhpt23/whisper-medium-chinesemed-full', 'Hanhpt23/whisper-small-chinesemed-full', 'Hanhpt23/whisper-base-chinesemed-full', 'Hanhpt23/whisper-tiny-chinesemed-full'],
        'de': ['Hanhpt23/whisper-medium-GermanMed-full', 'Hanhpt23/whisper-small-GermanMed-full', 'Hanhpt23/whisper-base-GermanMed-full', 'Hanhpt23/whisper-tiny-GermanMed-full']
    }
    ...
    for i, language in enumerate(languages):
        ...
        for model_name in model_name_list:
            ...
            try:
                ...
                cer_score = 100 * cer_metric.compute(predictions=result["prediction"], references=result["reference"])

                # print(f"Model: {model_name} - WER: {wer_score:.2f}")
