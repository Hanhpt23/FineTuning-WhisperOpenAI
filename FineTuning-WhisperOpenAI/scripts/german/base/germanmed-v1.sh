...
#SBATCH --job-name=B74       # create a short name for your job
#SBATCH --output=./gpu_output/Train_base_GermanMed-full-JOB_ID_%j-%N.log # create output file
...
python3 -m src.train \
    --output_dir "./whisper-base-GermanMed-full" \
